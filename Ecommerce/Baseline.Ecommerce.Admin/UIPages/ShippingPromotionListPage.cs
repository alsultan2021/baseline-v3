...
[assembly: UIPage(
    ...
    uiPageType: typeof(Baseline.Ecommerce.Admin.UIPages.ShippingPromotionListPage),
...
/// <summary>
/// Admin listing page for Shipping Promotions.
/// </summary>
[UIEvaluatePermission(SystemPermissions.VIEW)]
public class ShippingPromotionListPage : ListingPage
{
    ...
    public override async Task ConfigurePage()
    {
        ...
        if (!dataClassExists)
        {
            ...
            {
                Headline = "Shipping Promotions Not Yet Available",
        ...
        PageConfiguration.QueryModifiers.AddModifier((query, _) =>
            query.WhereEquals(nameof(PromotionInfo.PromotionType), (int)PromotionTypeEnum.Shipping));

        PageConfiguration.TableActions.AddDeleteAction(nameof(Delete));
        PageConfiguration.HeaderActions.AddLink<ShippingPromotionCreatePage>("Create shipping promotion");
        PageConfiguration.AddEditRowAction<ShippingPromotionEditPage>();

        PageConfiguration.ColumnConfigurations
            .AddColumn(nameof(PromotionInfo.PromotionDisplayName), "Name", searchable: true, maxWidth: 20)
            .AddColumn(nameof(PromotionInfo.PromotionShippingDiscountType), "Discount Type", formatter: (val, _) =>
                (int)val switch
                {
                    0 => "Free Shipping",
                    1 => "Reduced Rate",
            ...
            .AddColumn(nameof(PromotionInfo.PromotionDiscountValue), "Value", maxWidth: 10)
