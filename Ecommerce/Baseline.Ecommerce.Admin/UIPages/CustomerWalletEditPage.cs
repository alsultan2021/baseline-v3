...
[assembly: UIPage(
    ...
    slug: "details",
    uiPageType: typeof(Baseline.Ecommerce.Admin.UIPages.CustomerWalletEditPage),
    name: "Details",
...
/// <summary>
/// Admin page for viewing/editing wallet details within customer context.
/// </summary>
[UIEvaluatePermission(SystemPermissions.UPDATE)]
public class CustomerWalletEditPage : ModelEditPage<WalletViewModel>
{
    private WalletViewModel? model = null;

    public CustomerWalletEditPage(
