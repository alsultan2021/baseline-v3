...
[assembly: UIPage(parentType: typeof(Kentico.Xperience.Admin.Base.UIPages.ChannelEditSection),
    ...
    uiPageType: typeof(Baseline.Account.Admin.MemberPasswordChannelSettingsExtender),
...
/// <summary>
/// Admin UI page for configuring Member Password channel settings.
/// </summary>
public class MemberPasswordChannelSettingsExtender(
    ...
    : ChannelCustomSettingsPage<MemberPasswordChannelSettingsFormAnnotated>(
...
/// <summary>
/// Form-annotated version of MemberPasswordChannelSettings for admin UI.
/// </summary>
